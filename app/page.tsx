          ...
          <div className="grid grid-cols-3 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-9 gap-x-5 gap-y-12 pb-8">
            {Array.from({ length: 12 }).map((_, i) => (
              <div key={i} className="group">
                <div className="aspect-[4/5] bg-brutalist-grey bg-opacity-10 animate-pulse rounded-none mb-2"></div>
                <div className="text-center">
                  <div className="h-4 bg-brutalist-grey bg-opacity-10 animate-pulse rounded-none mb-1"></div>
                  <div className="h-3 bg-brutalist-grey bg-opacity-10 animate-pulse rounded-none w-16 mx-auto"></div>
                </div>
              </div>
            ))}
          </div>
        ...
        <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 lg:grid-cols-6 xl:grid-cols-8 2xl:grid-cols-10 gap-x-3 sm:gap-x-4 lg:gap-x-5 gap-y-8 sm:gap-y-10 lg:gap-y-12 pb-8">
          {filteredProducts.length === 0 ? (
            <div className="col-span-full flex flex-col items-center justify-center py-12 sm:py-16">
              <div className="bg-brutalist-grey bg-opacity-5 rounded-none p-6 sm:p-8 text-center max-w-md mx-auto">
                <div className="size-12 mx-auto mb-4 bg-brutalist-grey bg-opacity-20 rounded-none flex items-center justify-center">
                  <svg className="size-6 text-brutalist-grey" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4" />
                  </svg>
                </div>
                <p className="font-mono text-sm text-brutalist-grey mb-2 font-medium">
                  No products found
                </p>
                <p className="font-mono text-xs text-brutalist-grey leading-relaxed">
