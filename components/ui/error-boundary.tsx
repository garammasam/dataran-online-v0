          ...
          <div className="text-center max-w-md">
            ...
            <div className="space-y-3">
              <button
                ...
                className="w-full bg-black text-white px-6 py-3 font-mono text-sm font-semibold hover:bg-gray-800 transition-colors uppercase"
              >
                Refresh Page
              </button>
              <button
                onClick={() => typeof window !== 'undefined' && (window.location.href = '/')}
                className="w-full bg-gray-100 text-black px-6 py-3 font-mono text-sm font-semibold hover:bg-gray-200 transition-colors uppercase"
              >
                Go Home
              </button>
            </div>
